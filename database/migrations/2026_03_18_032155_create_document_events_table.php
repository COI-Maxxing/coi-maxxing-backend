...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE document_events ADD CONSTRAINT check_event_type CHECK (event_type IN ('uploaded', 'extraction_started', 'extraction_failed', 'validated', 'extracted', 'rejected', 'expiring_soon', 'expired', 'update_requested'))");
